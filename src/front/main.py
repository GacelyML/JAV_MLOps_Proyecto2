...
Elevation = col1.number_input("Elevation", value=0)
Aspect = col1.number_input("Aspect", value=0)
Slope = col1.number_input("Slope", value=0)
Horizontal_Distance_To_Hydrology = col1.number_input("Horizontal_Distance_To_Hydrology", value=0)

Vertical_Distance_To_Hydrology = col2.number_input("Vertical_Distance_To_Hydrology", value=0)
Horizontal_Distance_To_Roadways = col2.number_input("Horizontal_Distance_To_Roadways", value=0)
Hillshade_9am = col2.number_input("Hillshade_9am", value=0)
Hillshade_Noon = col2.number_input("Hillshade_Noon", value=0)

Hillshade_3pm = col3.number_input("Hillshade_3pm", value=0)
Horizontal_Distance_To_Fire_Points = col3.number_input("Horizontal_Distance_To_Fire_Points", value=0)
Wilderness_Area = col3.text_input("Wilderness_Area")
Soil_Type = col3.text_input("Soil_Type")
